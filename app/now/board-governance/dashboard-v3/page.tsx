...
// Reordered tabs: Topic Trends first, then Governance Maturity, then External Context
...
// ============================================================================
// Main Page - v3 with "What's Changed"
// ============================================================================

export default function GovernanceDashboardV3Page() {
        ...
        <div style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <Link href="/now/board-governance/dashboard-v2" style={{ fontSize: 11, color: colors.text.muted, textDecoration: "none" }}>
                ← v2 Light
              </Link>
              <Link href="/now/board-governance/dashboard-v2/dark" style={{ fontSize: 11, color: colors.text.muted, textDecoration: "none" }}>
                v2 Dark
              </Link>
            </div>
          </div>
      ...
      <div style={{ 
        ...
        {showChangeBanner && CHANGES_SINCE_LAST_VISIT.length > 0 && (
          <div style={{ 
            ...
            borderBottom: `1px solid ${colors.accent.indigo}40`,
          }}>
            {/* Collapsed view */}
            <div 
              style={{ 
                  ...
                  {CHANGES_SINCE_LAST_VISIT.map((change) => (
                    <div 
                      ...
                      style={{ 
                        ...
                        padding: "12px 16px", 
                        minWidth: 280,
                        border: change.impact === "high" ? `1px solid ${colors.accent.red}40` : `1px solid ${colors.border.default}`,
        ...
        <main style={{ flex: 1, overflowY: "auto", background: colors.bg.card, minHeight: 0 }}>
          ...
          <div style={{ padding: "20px 0" }}>
            ...
            {/* GOVERNANCE MATURITY (now second) */}
            {activeTab === "maturity" && (
              <div>
