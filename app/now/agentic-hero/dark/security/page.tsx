...
function PromptComposer({ placeholder, contextLabel, dock }: { placeholder: string; contextLabel?: string; dock: "main" | "rail" }) {
  return (
    <div className={cn("rounded-2xl border border-[#30363d] bg-[#161b22] shadow-sm")}>
      {contextLabel && (
        <div className="flex items-center justify-between border-b border-[#30363d] px-4 py-2">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-[#30363d] bg-[#21262d] px-3 py-1 text-xs text-[#8b949e]">
      ...
      <div className="p-4">
        <div className="flex items-center gap-3">
          <button className="flex h-10 w-10 items-center justify-center rounded-full border border-[#30363d] bg-[#161b22] text-[#8b949e] hover:bg-[#21262d] hover:text-[#f0f6fc]">
            <Icon name="paperclip" className="h-5 w-5" />
          </button>
          <div className="flex-1">
            <div className="text-sm text-[#6e7681]">{placeholder}</div>
            <div className="mt-1 h-5 w-full rounded bg-[#21262d]" />
          </div>
          <button className="flex h-10 w-10 items-center justify-center rounded-full border border-[#30363d] bg-[#161b22] text-[#8b949e] hover:bg-[#21262d] hover:text-[#f0f6fc]">
            <Icon name="mic" className="h-5 w-5" />
          </button>
          <button className="flex h-10 w-10 items-center justify-center rounded-full border border-[#58a6ff] bg-[#58a6ff] text-[#0d1117] hover:bg-[#79b8ff]">
        ...
        {dock === "main" ? (
          <>
            ...
            <div className="mt-4 text-center text-xs text-[#6e7681]">
              AI-generated content may have inaccuracies. <span className="underline decoration-[#6e7681]/50 underline-offset-2">Learn more</span>
            </div>
          </>
        ) : (
          <div className="mt-3 text-xs text-[#6e7681]">Ask follow-up questions about this incident without leaving the review panel.</div>
        )}
      </div>
    </div>
  );
