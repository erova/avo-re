    ...
    <div className="w-full border-b border-gray-200 bg-white">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-3">
        ...
        <nav className="flex flex-wrap items-center gap-2">
          ...
          <a href="/now/agentic-hero/light/compliance" className="rounded-full border border-[#EE312E]/30 bg-[#EE312E]/5 px-3 py-1 text-xs font-semibold text-[#EE312E] hover:bg-[#EE312E]/10">Global Compliance</a>
       ...
       >
         <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
           <div className="min-w-0">
             <div className="text-xs text-gray-500">Compliance review</div>
               ...
               <div className="mx-auto mt-6 max-w-[860px]">
                 <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                   <div className="flex items-start justify-between gap-3">
                     <div className="min-w-0">
                       <div className="text-xs uppercase tracking-wide text-gray-500">Compliance review</div>
             ...
             <div className="h-full overflow-y-auto">
               ...
               <div className="mx-auto max-w-[950px] px-6 py-8 space-y-8">
                 ...
                 <section className="rounded-xl border border-gray-200 bg-gray-50 p-5">
                   <div className="flex items-center justify-between">
                     <h3 className="text-sm font-semibold text-gray-900">Governance tasks (draft)</h3>
                     <span className="text-xs text-gray-500">Owner: Risk Manager</span>
                   </div>
                   <div className="mt-3 space-y-2 text-sm text-gray-700">
                 ...
                 <section className="rounded-xl border border-gray-200 bg-gray-50 p-5">
                   <div className="flex items-center justify-between">
                     <h3 className="text-sm font-semibold text-gray-900">Tracking reminders (draft)</h3>
                     <span className="text-xs text-gray-500">Cadence: Weekly</span>
                   </div>
                   <div className="mt-3 space-y-2 text-sm text-gray-700">
                 ...
                 <section className="rounded-xl border border-gray-200 bg-gray-50 p-5">
                   <div className="flex items-center justify-between">
                     <h3 className="text-sm font-semibold text-gray-900">Evidence requests (draft)</h3>
                     <span className="text-xs text-gray-500">Source: Entity owners</span>
                   </div>
                   <div className="mt-3 space-y-2 text-sm text-gray-700">
